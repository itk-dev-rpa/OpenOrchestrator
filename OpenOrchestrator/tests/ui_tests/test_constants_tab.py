...
class TestConstantsTab(unittest.TestCase):
    ...
    def test_constants_table(self):
        ...
        table_data = test_helper.get_table_data(self.browser, "constants_tab_constants_table")
    ...
    def test_credentials_table(self):
        ...
        table_data = test_helper.get_table_data(self.browser, "constants_tab_credentials_table")
    ...
    def test_create_credential(self):
        ...
        crypto_util.set_key(test_helper.ENCRYPTION_KEY)
    ...
    def test_edit_constant(self):
        ...
        test_helper.click_table_row(self.browser, "constants_tab_constants_table", 0)
    ...
    def test_edit_credential(self):
        ...
        test_helper.click_table_row(self.browser, "constants_tab_credentials_table", 0)
