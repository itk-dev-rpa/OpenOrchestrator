...
class TestTriggerPolling(unittest.TestCase):
    ...
    def test_poll_triggers_single(self, *_):
        ...
        db_util.create_single_trigger("Future single trigger", "", datetime(2100, 1, 1), "", "", False, False, 0, [], "branch")
        trigger = runner.poll_triggers(mock_app)
        self.assertIsNone(trigger)

        # Test with overdue trigger
        db_util.create_single_trigger("Past single trigger", "", datetime(2020, 1, 1), "", "", False, False, 0, [], "branch")
        trigger = runner.poll_triggers(mock_app)
    ...
    def test_poll_triggers_priority(self, *_):
        ...
        db_util.create_single_trigger("Low", "", datetime(2000, 1, 1), "", "", False, False, 0, [], "branch")
        db_util.create_single_trigger("High", "", datetime(2000, 1, 1), "", "", False, False, 100, [], "branch")

        trigger = runner.poll_triggers(mock_app)
        self.assertEqual(trigger.trigger_name, "High")

        db_util.create_single_trigger("Higher Future", "", datetime(2100, 1, 1), "", "", False, False, 200, [], "branch")
    ...
    def test_poll_triggers_mixed(self, *_):
        ...
        db_util.create_queue_trigger("Queue", "", "Queue", "", "", False, False, 1, 0, [], "branch")
        db_util.create_queue_element("Queue")
        trigger = runner.poll_triggers(mock_app)
        self.assertEqual(trigger.trigger_name, "Queue")

        db_util.create_scheduled_trigger("Scheduled", "", "", datetime(2000, 1, 1), "", "", False, False, 0, [], "branch")
        trigger = runner.poll_triggers(mock_app)
        self.assertEqual(trigger.trigger_name, "Scheduled")

        db_util.create_single_trigger("Single", "", datetime(2000, 1, 1), "", "", False, False, 0, [], "branch")
        trigger = runner.poll_triggers(mock_app)
        self.assertEqual(trigger.trigger_name, "Single")

        db_util.create_queue_trigger("Queue High", "", "Queue", "", "", False, False, 1, 1, [], "branch")
        trigger = runner.poll_triggers(mock_app)
        self.assertEqual(trigger.trigger_name, "Queue High")

        db_util.create_scheduled_trigger("Scheduled High", "", "", datetime(2000, 1, 1), "", "", False, False, 1, [], "branch")
        trigger = runner.poll_triggers(mock_app)
        self.assertEqual(trigger.trigger_name, "Scheduled High")

        db_util.create_single_trigger("Single High", "", datetime(2000, 1, 1), "", "", False, False, 1, [], "branch")
        trigger = runner.poll_triggers(mock_app)
    ...
    def test_poll_triggers_blocking(self, *_):
        ...
        db_util.create_single_trigger("Single Blocking", "", datetime(2000, 1, 1), "", "", False, True, 0, [], "branch")
        trigger = runner.poll_triggers(mock_app)
        self.assertIsNone(trigger)

        db_util.create_single_trigger("Single Non-blocking", "", datetime(2000, 1, 1), "", "", False, False, 0, [], "branch")
        trigger = runner.poll_triggers(mock_app)
    ...
    def test_poll_triggers_whitelist_non_exclusive(self, *_):
        ...
        db_util.create_single_trigger("Single non machine", "", datetime(2000, 1, 1), "", "", False, False, 0, ["Non machine"], "branch")
        trigger = runner.poll_triggers(mock_app)
        self.assertIsNone(trigger)

        db_util.create_single_trigger("Single no whitelist", "", datetime(2000, 1, 1), "", "", False, False, 0, [], "branch")
        trigger = runner.poll_triggers(mock_app)
    ...
    def test_poll_triggers_whitelist_exclusive(self, *_):
        ...
        db_util.create_single_trigger("Single whitelist", "", datetime(2000, 1, 1), "", "", False, False, 0, ["Machine"], "branch")
        trigger = runner.poll_triggers(mock_app)
